...
print("The number list before change:",number_list) 
print("The id of number list before change: ",id(number_list)) #to get id of number_list
i=0
while i < len(number_list):
    if number_list[i]>50:
       number_list.pop(i)       #remove the number from list
    else:
        i+=1
